...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        load->setGeometry(QRect(530, 20, 75, 23));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(40, 110, 791, 561));
        filp = new QPushButton(centralWidget);
        filp->setObjectName(QStringLiteral("filp"));
        filp->setGeometry(QRect(610, 20, 75, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        filp->setText(QApplication::translate("MainWindow", "filp", nullptr));
    } // retranslateUi
